...
#define STRING_VERSION_CONFIG_H __DATE__ "2015-06-13 13:29" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Gary Servin, Prusa i3 Rework)" // Who made the changes.
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 353.50
    #define  DEFAULT_bedKi 24.80
    #define  DEFAULT_bedKd 1259.69
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,8000,266.6}  // default steps per unit for Ultimaker
